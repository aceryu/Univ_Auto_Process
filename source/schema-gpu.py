...
table_dic['field_training'] = \
    ...
    `ft_4w_training_institution_tot_school` int(6) DEFAULT 0 COMMENT '실습기간_4주_실습기관 수_학교 주도',\
    `ft_4w_training_institution_tot_institut` int(6) DEFAULT 0 COMMENT '실습기간_4주_실습기관 수_실습 기관 주도',\
    ...
    `ft_8w_training_institution_tot_school` int(6) DEFAULT 0 COMMENT '실습기간_8주_실습기관 수_학교 주도',\
    `ft_8w_training_institution_tot_institut` int(6) DEFAULT 0 COMMENT '실습기간_8주_실습기관 수_실습 기관 주도',\
    ...
    `ft_12w_training_institution_tot_school` int(6) DEFAULT 0 COMMENT '실습기간_12주_실습기관 수_학교 주도',\
    `ft_12w_training_institution_tot_institut` int(6) DEFAULT 0 COMMENT '실습기간_12주_실습기관 수_실습 기관 주도',\
...
table_dic['contract_department'] = \
    ...
    `new_tech` varchar(5) COMMENT '첨단(신기술)분야 여부 (O/X)',\
...
# 2023년_ [8-마-4. 대차대조표_]
#################################################
# 테이블명 : corporation_balance_sheet | 2023년_ [8-마-4. 대차대조표_]
...
table_dic['instructor_fee'] = \
    ...
    `time classification` varchar(50) COMMENT '구분',\
    `hour_price` int(6) DEFAULT 0 COMMENT '시간당 지급기준 단가(원)', \
    `recipients_tot` int(6) DEFAULT 0 COMMENT '지급인원수', \
    `lecture hour_tot` int(6) DEFAULT 0 COMMENT '총 강의시간 수', \
